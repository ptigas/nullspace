<?php get_header(); ?>
	<div style="height:40px">
		...
		<div class="grid_12 omega">
			KEYWORD: <i><?php the_search_query(); ?></i>
		</div>		
	</div>
		...
		<div class="post">
			...
			<div class="grid_12 omega">
				<div class="no-results">
					...
					<p>We apologize for any inconvenience, please <a href="<?php bloginfo('url'); ?>/" title="<?php bloginfo('description'); ?>">return to the home page</a> or use the search form again.</p>
				</div><!--noResults-->
			</div>
		</div>
	<?php endif; ?>
